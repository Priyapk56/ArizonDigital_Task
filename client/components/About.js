export default function About() {
  return (
    <div className="bg-white px-6 py-12 max-w-5xl mx-auto">
...
Our mission is to become the number one choice for premium bearings and auxiliary engineering products, offering the fastest and most reliable service worldwide. We pride ourselves on the array of services we offer and how flexible we can be to cater to the needs and pressures our customers face. We want to provide this level of service and trust to customers worldwide so that we can become your number one choice as a supplier.



Never Competing, Always Exceeding
...
Responsible | Excellence | Shared Success | Ambitious | Quality
We want to achieve our mission whilst delivering the shared core values above through our behaviour and commitments to our environment, local communities, and each other. We want to work alongside stakeholders who share the same values to help us deliver our mission.      </p>
    </div>
  );
}
