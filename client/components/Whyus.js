  ...
  return (
    <section className="bg-gray-100 py-12 px-4 md:px-10">
      <div className="max-w-4xl mx-auto text-center space-y-6">
        <h2 className="text-2xl md:text-3xl font-oswald font-bold text-blue-1100">
          Why Choose Quality Bearings Online?
        </h2>
        <p className="text-blue-900 text-lg font-sans leading-relaxed">
        ...
        <button className="mt-4 px-6 py-3 bg-yellow-600 hover:bg-white-500 text-white font-semibold rounded transition">
          Read More
        </button>
      </div>
    </section>
